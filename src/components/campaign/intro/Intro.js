...
const Intro = () => {
    ...
    return <>
        <Prologue imageSrc={"https://i.ibb.co/3sQJLqS/icon-battle.png"} alt="" maxHeight="80px">Aside from city building and Capital City quests, the other major component is the PvE military campaign through which player's engages the armies of famous leaders from the past, some of which become Commanders for your army.<br/>
