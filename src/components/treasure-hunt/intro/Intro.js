...
import Technology_BronzeAge_TreasureHunt from "../../../images/treasure-hunt/intro/Technology_BronzeAge_TreasureHunt.webp";
import Technology_BronzeAge_Alliances from "../../../images/treasure-hunt/intro/Technology_BronzeAge_Alliances.webp";
import icon_ath_difficulty_0 from "../../../images/treasure-hunt/intro/icon_ath_difficulty_0.webp";
import icon_ath_encounter from "../../../images/treasure-hunt/checkpoints/icon_ath_encounter.webp";
import Technology_KingdomOfSicily_MagnifyingGlass from "../../../images/treasure-hunt/intro/Technology_KingdomOfSicily_MagnifyingGlass.webp";
...
const Intro = (props) => {
    ...
    return <>
        ...
        <Image src={Technology_BronzeAge_Alliances} alt="" spacing={true} width={'100px'}/>
        ...
        <Image src={icon_ath_difficulty_0} alt={""} spacing={true} width={'100px'}/>
        ...
        <Image src={icon_ath_encounter} alt={""} spacing={true} width={'100px'}/>
        ...
        <Image src={Technology_KingdomOfSicily_MagnifyingGlass} alt={""} spacing={true} width={'100px'}/>
