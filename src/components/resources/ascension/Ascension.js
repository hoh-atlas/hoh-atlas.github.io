...
const Ascension = () => {
    ...
    const ascensionAdditionalData = [
        {id: "charta_terrestre", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=charta_terrestre" className="text-link">these</Link>},
        {id: "crested_guidon", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=crested_guidon" className="text-link">these</Link>},
        ...
        {id: "fragrant_potpourri", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=fragrant_potpourri" className="text-link">these</Link>},
        {id: "gilded_pennant", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=gilded_pennant" className="text-link">these</Link>},
        {id: "herbal_poultice", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=herbal_poultice" className="text-link">these</Link>},
        {id: "hortus_sanitatis", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=hortus_sanitatis" className="text-link">these</Link>},
        ...
        {id: "shadow_dial", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=shadow_dial" className="text-link">these</Link>},
        ...
        {id: "travelers_compass", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=travelers_compass" className="text-link">these</Link>},
        {id: "war_horn", description1: "", description2: "Ascension of _ heroes", link: <Link to="/heroes?ascensionMaterial=war_horn" className="text-link">these</Link>},
    ]
